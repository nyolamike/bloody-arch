defmodule Cell.Tag.Util.Test do
  ...
  test "Tag cell follow_tag -> follows a user by adding the users uuid to the list of followers" do
    receiver = self()
    user_uuid = "4657585"
  ...
  test "Tag cell un_follow_tag -> unfollows a user from the tag" do
    receiver = self()
    user_uuid = "4657585"
  ...
  test "Tag cell get_followers -> returns a list of followers" do
    receiver = self()
  ...
  test "Tag cell add_tag_resource -> adds a uuid of a resource to the list of its resources " do
    receiver = self()
  ...
  test "Tag cell get_resources -> returns a list of resources uuids" do
    receiver = self()
    ...
    un_modified_state = Cell.Tag.Util.get_resources(
      receiver,
      request_msg |> Map.put(:thread, []),
      initial_state
    )
